    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
                    Bandana cerdas dengan teknologi EEG untuk monitoring kesehatan otak, penanganan ADHD, dan analisis kesehatan mental.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @foreach ([['home', 'Home'], ['fitur', 'Fitur'], ['tentang', 'Tentang'], ['faq', 'FAQ'], ['kontak', 'Kontak']] as [$route, $label])
                        <li>
                            <a href="{{ route($route) }}" class="text-sm text-neutral-500 dark:text-neutral-400 hover:text-primary dark:hover:text-primary-light transition-colors">
                                {{ $label }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @foreach (['Brain Waves Monitoring', 'Multi Parametric Analysis', 'Neuro Feedback Music', 'ADHD Management', 'AI Consultant'] as $fitur)
                        <li>
                            <a href="{{ route('fitur') }}" class="text-sm text-neutral-500 dark:text-neutral-400 hover:text-primary dark:hover:text-primary-light transition-colors">
                                {{ $fitur }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div class="mt-12 pt-8 border-t border-neutral-200 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-sm text-neutral-400 dark:text-neutral-500">
                &copy; {{ date('Y') }} Neuralis. All rights reserved.
            </p>
            <div class="flex items-center gap-4">
                {{-- Social links placeholder --}}
                <a href="#" class="text-neutral-400 hover:text-primary dark:hover:text-primary-light transition-colors">
